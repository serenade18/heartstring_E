...
class PlayTime(models.Model):
    ...
    time1 = models.CharField(max_length=255, default=None)
    time2 = models.CharField(max_length=255, default=None)
    time3 = models.CharField(max_length=255, default=None)
    added_on = models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
